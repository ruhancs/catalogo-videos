import { UpdateGenreOutput, UpdateGenreUseCase } from '../update-genre.usecase';
...
describe('UpdateGenreUseCase Integration Tests', () => {
  ...
  it('rollback transaction', async () => {
    ...
    //pegar evento de quando um genre é atualizado,
    //no momento que o genre for atualizado lanca um erro
