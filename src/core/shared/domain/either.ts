...
//Either é um monad, padrao de linguagem funcional
//é uma funcao que ajuda a lidar com determinados efeitos na programacao
//ex um objeto que nao se sabe que a propiedade é undefined, esquecer um await em uma promisse
