...
import { CAST_MEMBERS_PROVIDERS } from '../cast-member-module/cast-members.providers';
...
export const USE_CASES = {
  ...
  UPLOAD_AUDIO_VIDEO_MEDIA_USE_CASE: {
    ...
    inject: [
      ApplicationService, //ApplicationService registrado em shared module
      REPOSITORIES.VIDEO_REPOSITORY.provide,
      'IStorage', //IStorage registrado em shared module
    ],
  },
  GET_VIDEO_USE_CASE: {
  ...
  PROCESS_AUDIO_VIDEO_MEDIA_USE_CASE: {
    provide: ProccessAudioVideoMediasUseCase,
    useFactory: (uow: IUnitOfWork, videoRepo: IVideoRepository) => {
      return new ProccessAudioVideoMediasUseCase(uow, videoRepo);
    },
    //UnitOfWork declarado em database.module
...
export const HANDLERS = {
  PUBLISH_VIDEO_MEDIA_REPLACED_IN_QUEUE_HANDLER: {
    ...
    inject: ['IMessageBroker'], //IMessageBroker instanciado em rabbitmq.module.ts em forFeature
  },
};
