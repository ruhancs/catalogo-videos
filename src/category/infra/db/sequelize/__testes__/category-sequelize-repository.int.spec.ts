...
describe("CategorySequelizeRepository Integracao tests", () => {
    ...
    it("should finds a entity by id", async () => {
        ...
        expect(entity.category_id.id).toBe(entityFound.category_id.id);
        expect(entity.name).toBe(entityFound.name);
        expect(entity.description).toBe(entityFound.description);
        expect(entity.is_active).toBe(entityFound.is_active);
      });
      ...
      it("should update a entity", async () => {
        ...
        expect(entity.toJSON().name).toStrictEqual(entityFound.toJSON().name);
      });
